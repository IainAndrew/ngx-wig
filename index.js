import { Component, EventEmitter, Input, NgModule, Output, ViewChild, ViewEncapsulation, forwardRef } from '@angular/core';
...
var NgxWigComponent = (function () {
        ...
        { type: Component, args: [{
                    ...
                    providers: [
                        NgxWigToolbarService,
                        {
                            ...
                            useExisting: forwardRef(function () { return NgxWigComponent; }),
                            multi: true
                        }
                    ],
    ...
    NgxWigComponent.propDecorators = {
        ...
        "buttons": [{ type: Input },],
        "disabled": [{ type: Input },],
        "isSourceModeAllowed": [{ type: Input },],
        "contentChange": [{ type: Output },],
        "ngxWigEditable": [{ type: ViewChild, args: ['ngWigEditable',] },],
    };
...
export { NgxWigModule, NgxWigComponent, NgxWigToolbarService };
